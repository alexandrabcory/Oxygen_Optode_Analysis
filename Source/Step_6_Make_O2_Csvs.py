...
def saveO2ConcToCSVs(imageName, inputFolderPath, outputFolderPath_2, csv_calCurveParamsByOptode, resolutionDecreaseFactor, optodeNumber, xMin, xMax, yMin, yMax, daysToAdd, site):
